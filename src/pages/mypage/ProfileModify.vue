          ...
          <div class="line">
            ...
            <div class="select-container">
              <div class="select-box"
                @click="this.company_size_open = !this.company_size_open; this.inflow_open = false;">
          ...
          <div class="line">
            ...
            <div class="select-container">
              <div class="select-box" @click="this.inflow_open = !this.inflow_open; this.company_size_open = false">
                {{ this.inflow_list.findIndex(i => i.v == this.inflow) >= 0 ?
                  this.inflow_list[this.inflow_list.findIndex(i => i.v == this.inflow)].t : '' }}
                <span class="icn"></span>
              </div>
